...
| 字段名     | 说明                                                                                                      |
| ---------- | --------------------------------------------------------------------------------------------------------- |
| battlemode | 对战模式（参考[查询订单数据](#查询订单数据)响应的[config 字段](#config-字段)的[battlemode](#battlemode)） |
| oid        | 订单编号                                                                                                  |
| bnetpwd    | 战网密码前 4 位                                                                                           |
...
| 字段名       | 说明                                                                                                          |
| ------------ | ------------------------------------------------------------------------------------------------------------- |
| battleheroes | 英雄掩码（参考[查询订单数据](#查询订单数据)响应的[config 字段](#config-字段)的[battleheroes](#battleheroes)） |
| oid          | 订单编号                                                                                                      |
| bnetpwd      | 战网密码前 4 位                                                                                               |
...
| 字段名  | 说明                                                                                                  |
| ------- | ----------------------------------------------------------------------------------------------------- |
| auto    | 是否自动领取奖励（参考[查询订单数据](#查询订单数据)响应的[config 字段](#config-字段)的[auto](#auto)） |
| oid     | 订单编号                                                                                              |
| bnetpwd | 战网密码前 4 位                                                                                       |
